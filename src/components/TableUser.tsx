...
const TABLE_ROWS = [
  {
    ...
    api_key: "uji@cahayamascemerlang",
    screet_key: "561fede4-c101-42fd-8cec-da9739aa85ff",
  },  {
    username: "dlhbangli",
    nama_instansi: "DLH Kab Bangli",
    api_key: "uji@dlhbangli",
    screet_key: "561fede4-c101-42fd-8cec-da9739aa85ff",
  },
    ...
    <Card className="h-full w-full">
      ...
      <CardBody className=" px-0">
        <table className="mt-4 w-full min-w-max table-auto text-left">
          ...
          <tbody>
            {TABLE_ROWS.map(
              ({ username, nama_instansi, api_key, screet_key }, index) => {
